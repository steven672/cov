...
covFeatureLoaders['tab-linear']['tab-linear-sec-overview'].push(
    function incidents_components_comcastSuper8TopErrorsLinear
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-comcast-super8-clinear-1day'
            ;
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Super8 Worst 10 Errors (cLinear) (1 Day)')
        ...
        loadDataApiQuery(
            '/api/combined/super8/errors/top10/cLinear/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/clinear/incidents/duplicates/2017-02-22' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                var
