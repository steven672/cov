...
covFeatureLoaders['tab-linear']['tab-linear-sec-overview'].push(
    function incidents_linear_comcast_mttr_productrollup_24hrs
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-incidents-linear-comcast-mttr-productrollup-24hrs',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Title 6 & TVE Linear Incidents : By Platform (24 hours)')
            )
            .append(
               ...
               .append(
                    ...
                    .append($('<li>').text('MTTR is displayed in DD:HH:MM format '))
                )
            )
         ...
         var cellNames = [
            {id: 'incidents-linear-comcast-mttr-productrollup-24hrs-element',                                 text: 'Platform'},
        ...
        loadDataApiQuery(
            '/api/snow/incidents/comcast/linear/t6tve/impactedservices/' + dateStart + '/' + dateEnd,    // The suffix of the URL for the API query, such as 'http://dev-coa/api/clinear/combined/availability/average/comcast/2017-02-21/2017-02-23'
            function (response)
            {
                ...
                for (index in dataArray)
                    ...
                    // Add a cell with the platform (ex: Title 6 Linear or TVE)
                    newRow.append(
                        $('<td>')
                        .html(stream['u_vops_impacted_services'])
                    );


                    // Add a cell with the total amount of Sev warnings
                    ...
                    // Add a cell with the Sev1 Count
                    newRow.append(
                        $('<td>')
