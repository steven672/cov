// Module: Capacity > Overview > helpers-tab-summary-sec-overview.js file
...
function capacity_overview_buildTableCell_GraphAndRatioRawNodes(
    parentId = null,
    tileData = null,
...
function capacity_overview_loadDataApiQuery_Build_Tile_From_Result_cDVR(
    parentId = null,
    data = null,
    ratioUtilField = null,
    rawUtilField = null,
...
)
{
    ...
    else
    {
        ...
        capacity_capacity_loadDataApiQuery_Report_No_Data_HTML(parentId);
    }//end if
}

// Build a table structure before running the API call
function capacity_overview_loadDataApiQuery_Build_Table(
    tableId = null,
    apiQuery = null,
