covFeatureLoaders['tab-capacity']['tab-capacity-sec-overview'].push(
    function capacity_cdvr_legacyCsSites
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-legacy-cs-sites',
        ...
        capacity_cdvr_buildTableFromAPIQuery(
            ...
            apiQuery = '/api/cdvr/legacy/cs/sites/all/' + dateStart,
            codeToRunOnSuccess = function (response)
            {
                ...
                for (index in dataArray)
                {
                    ...
                    var result = $.grep(
                        response.data.data,
                        function (e) {
                            return (e.site.toLowerCase() === region.cs.toLowerCase());
                        }
                    );
                    ...
                    capacity_cdvr_buildTableCell_GraphAndRatioRawNodes(
                        parentObjectId = sectionId + '-legacy-table-csArch' + index,
