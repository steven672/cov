covFeatureLoaders['tab-capacity']['tab-capacity-sec-overview'].push(
    function capacity_cdvr_legacyTrendingDDN
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        capacity_cdvr_buildTableFromAPIQuery(
            ...
            apiQuery = '/api/cdvr/legacy/trending/ddn/' + dateStart + "/" + dateEnd,
            codeToRunOnSuccess = function (response)
            {
                ...
                for (index in dataArray)
                {
                    ...
                    var resultRegion = $.grep(
                        ...
                        function (e) {
                            return (e.toLowerCase() === region.ddn.toLowerCase());
                        }
                    );
