...
function capacity_cdvr_buildTableCell_GraphAndRatioRawNodes(
    parentId = null,
    tileData = null,
...
)
{
    ...
    idTail = idArray[idArray.length - 1];
...
function capacity_cdvr_loadDataApiQuery_Build_Tile_From_cDVR(
    parentId = null,
    data = null,
    ratioUtilField = null,
    rawUtilField = null,
...
)
{
    ...
    if (data != null)
    {
        capacity_cdvr_buildTableCell_GraphAndPercentRawNodes(
        ...
        capacity_cdvr_loadDataApiQuery_Add_Graph_Pie_Utilization(
    ...
    else
    {
        ...
        capacity_cdvr_loadDataApiQuery_Report_No_Data_HTML(parentId);
    }//end if
}

// Build a table structure before running the API call
function capacity_cdvr_buildTableFromAPIQuery(
    tableId = null,
    apiQuery = null,
    ...
    loadDataApiQuery(
        ...
        function (response)
        {
            rowHeaders = getDataFromArrayByField(
                dataArray = response.regions ? response.regions : response.data.regions,
                fieldName = 'text'
            );
