// Module: Capacity > Overview > Daily % Change in CS Archive Utilization - 5 Best / 5 Worst

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-capacity']['tab-capacity-sec-overview'].push(
    function capacity_overview_legacyCsMinmax5
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-legacy-cs-minmax-5',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Daily % Change in CS Archive Utilization - 5 Best / 5 Worst')
        ...
        loadDataApiQuery(
            apiQuery = '/api/cdvr/legacy/cs/minmax/all/' + dateStart + '/' + dateEnd, // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14'
            codeToRunOnSuccess = function (response)
            {
                var
                    chartId = featureId + '-bar-chart',
                    dataArrayFromAPI = response.data.MinMaxCSArchive,
