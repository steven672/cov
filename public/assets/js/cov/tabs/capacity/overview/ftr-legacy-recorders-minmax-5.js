// Module: Capacity > Overview > Daily % Change in Recorders Archive Utilization - 5 Best / 5 Worst

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-capacity']['tab-capacity-sec-overview'].push(
    function capacity_overview_legacyRecordersMinmax5
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-legacy-recorders-minmax-5',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Daily % Change in Legacy Recorders - 5 Best / 5 Worst')
        ...
        loadDataApiQuery(
            apiQuery = '/api/cdvr/legacy/minmax/all/' + dateStart+ '/' + dateEnd, // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14
            codeToRunOnSuccess = function (response)
            {
                var
                    chartId = featureId + '-bar-chart',
                    dataArrayFromAPI = response.data.MinMaxLegacyRecorders,
