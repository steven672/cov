// Module: Rio > Overview > cDVR Subscriber Counts - Total and by Region

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-rio']['tab-rio-sec-overview'].push(
    function summary_cdvr_subscriber_counts
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cdvr-subscriber-counts',
        ...
        loadDataApiQuery(
            '/api/combined/subscriber/counts/region/cdvr_flag/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                var
                ...
                // Add a div showing the 'Total cDVR Subscribers' count
                $('#' + featureId + '-total-count')
                .append(
                    $('<small>')
                    .css('text-transform', 'uppercase')
                    .text('Total cDVR Subscribers')
                )
                .append(
                    $('<div>')
