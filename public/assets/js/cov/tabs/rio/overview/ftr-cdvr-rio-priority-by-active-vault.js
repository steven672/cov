// Module: Rio > Overview > Worst Five Rio Markets by Active Capacity Utilization

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-rio']['tab-rio-sec-overview'].push(
    function rio_overview_rioPriorityMarket_Active
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cdvr-rio-priority-by-active-vault',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Worst 5 Rio Markets by Active Vault Utilization')
        ...
        loadDataApiQuery(
            ...
            codeToRunOnSuccess = function (response)
            {
                ...
                var dataArray = response.data.regionsActive;
                // worstFiveMktsByHealthNames
                // worstFiveMktsByHealthNamesArchive
                var worstFiveMarkets = response.data.worstFiveMktsByHealthNamesActive;
