// Module: Rio > Overview > Worst Five Rio Markets by Total Capacity Utilization

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-rio']['tab-rio-sec-overview'].push(
    function rio_overview_rioPriorityMarket
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cdvr-rio-priority-market',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Worst 5 Rio Markets by Total Storage Utilization')
        ...
        loadDataApiQuery(
            ...
            codeToRunOnSuccess = function (response)
            {
                ...
                var worstFiveMarkets = response.data.worstFiveMktsByHealthNames;
