// Module: Incidents > Components > Cox 1 day
...
covFeatureLoaders['tab-incidents']['tab-incidents-sec-components'].push(
    function incidents_components_coxOverview1day
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cox-overview-1day'
            ;
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('COX Incidents: by Component (1 day)')
        ...
        loadDataApiQuery(
            '/api/clinear/incidents/components/cox/all/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/clinear/incidents/components/cox/all/2017-02-22' -- NOT 'http://dev-ccm-php///api/clinear/incidents/components/cox/all/2017-01-14'
            function (response)
            {
                var
                ...
                var cellNames = [
                    {id: tableId + '-components',     text: 'Component'},
