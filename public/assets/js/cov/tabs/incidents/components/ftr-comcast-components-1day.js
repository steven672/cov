// Module: Incidents > Components > Comcast component 1day
...
covFeatureLoaders['tab-incidents']['tab-incidents-sec-components'].push(
    function incidents_components_comcastOverview1day
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-comcast-overview-1day'
            ;
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Comcast Incidents By Components (24 hours) Title VI Linear , TVE Linear, Title VI VOD, TVE VOD')
        ...
        loadDataApiQuery(
            '/api/clinear/incidents/components/comcast/all/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/clinear/incidents/duplicates/2017-02-22' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                var
                ...
                buildTableHeader(
                 ...
                 var dataArray = response.data.Hours24;
