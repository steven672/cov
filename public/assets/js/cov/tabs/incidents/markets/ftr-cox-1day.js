// Module: Incidents > Markets > Cox 24h status
...
covFeatureLoaders['tab-incidents']['tab-incidents-sec-markets'].push(
    function incidents_components_coxMarket1day
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cox-market-1day'
            ;
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Cox Incidents: by Market (last day)')
        ...
        loadDataApiQuery(
            '/api/clinear/incidents/markets/cox/all/' + dateProvided,       // The suffix of the URL for the API query, such as '/api/clinear/incidents/duplicates/2017-02-22' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                var
