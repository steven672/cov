// Module: Performance > varnish RLRL CMC availability

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-performance']['tab-performance-sec-varnish'].push(
    function varnish_comcast_rlr_cmc_loadData_availability_24hrs
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Comcast T6 Linear RLR-CMC Stream Availability @ varnish  (7days)')
            ...
            .append(
                ...
                .append(
                    ...
                    .append($('<li>').html('<a href="https://splunk-cdvr.idk.cable.comcast.com/en-US/app/search/search?q=search%20%5B%7Cinputlookup%20super8IP1.csv%7Creturn%201000%20%24IP%5D%20earliest%3D%40d-24h%20latest%3D%40d%20host%3Drlr-cmc-varorg-*%20%20source%3D%2Fvar%2Flog%2Fhttpd%2Fmodlive_origin_access.log%20cRegion!%3DVBN%7Crex%20%22%5C%22%20(%3F%3Cresponse_code%3E%5Cd%5Cd%5Cd)%20%5B-0-9%5D%2B%20%22%20%7C%20rex%20%22%5C%2F(%3F%3Ctitle%3E%5B%5E%2F%5D*)%5C%2F(root_video*%7Cmanifest*%7Croot_audio*)%22%7C%20rex%20field%3Dtitle%20%22%5Cw*%5C_(HD%7CSD)%5C_(%3F%3Csite%3E%5BA-Z%5D*)%5C_%5Cd*%22%7Cstats%20count(eval(searchmatch(%22response_code!%3D2*%20%20AND%20response_code!%3D3*%22)))%20AS%20httpError%2C%20count(response_code)%20AS%20Total%20by%20site%7Ceval%20availability%25%3Dround((1-(%20httpError%2FTotal))*100%2C%202)%20%7Cfields%20site%20%20httpError%20%20availability%25&display.page.search.mode=verbose&earliest=&latest=&display.page.search.tab=statistics&display.general.type=statistics&sid=1495741503.3591092">Splunk Query Link</a>'))
                    .append($('<li>').text('RLR-Regional Linear Redundancy. CMC backup site names are extracted from varnish streamNames due to limited CMC market information in Splunk'))
                )
            )
        )
        ;
        ...
        var dateStart          = new Date(dateStartTimestamp * 1000).toISOString().split('T')[0];
          ...
          loadDataApiQuery(
              '/api/clinear/rlr/cmc/varnish/availability/' + dateStart + "/" + dateEnd,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
              function (response)
              {
