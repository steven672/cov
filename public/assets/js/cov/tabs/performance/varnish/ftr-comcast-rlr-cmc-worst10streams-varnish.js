...
covFeatureLoaders['tab-performance']['tab-performance-sec-varnish'].push(
    ...
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-comcast-rlr-cmc-worst10streams-varnish'
            ;
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('RLR - CMC Worst 10 Performing Streams at Varnish (24 hours)')
        ...
        loadDataApiQuery(
            '/api/clinear/rlr/cmc/varnish/worststreams/' + dateProvided + '/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
