...
covFeatureLoaders['tab-performance']['tab-performance-sec-pillar'].push(
    function performance_pillar_comcast_availability_24hrs
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        loadDataApiQuery(
            '/api/clinear/pillar/hot/streams/cox/all/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                var dataArray = response.data.responseCoxPillarPanicsHotNatStreams10Cox;
