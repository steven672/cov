// Module: Performance > pillar > Cox Pillar Manual Restart Counts and Error Minutes (24 hours) [Include TVE]

// --
// FEATURE FUNCTIONS
// --
covFeatureLoaders['tab-performance']['tab-performance-sec-pillar'].push(
    function performance_pillar_loadData_coxManualRestartsCountsAndErrorMinutes_24hrs
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-cox-pillar-manual-restart-24hrs'
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Cox Pillar Manual Restart Counts and Error Minutes (24 hours) [Include TVE]')
        ...
        var cellNames = [
            ...
            {id: featureId + '-table-restartCount',     text: 'Restart Count'},
            {id: featureId + '-table-errorMinutes',     text: 'Error Minutes (All Streams)'}
        ];

        // Run the query specified
        loadDataApiQuery(
            '/api/clinear/pillar/restarts/cox/10/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
                ...
                else
                {
                    ...
                    for (index in dataArray[dateProvided])
                    {
                        ...
                        // Add a cell with the count
                        newRow.append(
                            $('<td>')
                            .html(stream['count'])
                        );

                        // Add a cell with the error minutes
                        newRow.append(
                            $('<td>')
