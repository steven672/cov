...
covFeatureLoaders['tab-performance']['tab-performance-sec-super8'].push(
    function performance_super8_loadData_Availability_comcast_24hrs
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Comcast Stream Availability @ Super8 (24 hours)')
        ...
        loadDataApiQuery(
            '/api/clinear/super8/availability/comcast/' + dateProvided,    // The suffix of the URL for the API query, such as '/api/cdvr/legacy/cs/sites/2017-01-14' -- NOT 'http://dev-ccm-php//api/cdvr/legacy/cs/sites/2017-01-14'
            function (response)
            {
