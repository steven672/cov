    ...
    )
    {
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Comcast T6 Linear Stream Availability @ Varnish Trend (7 days)')
