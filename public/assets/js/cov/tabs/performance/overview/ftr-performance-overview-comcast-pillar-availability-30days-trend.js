...
covFeatureLoaders['tab-performance']['tab-performance-sec-overview'].push(
    function performance_overview_comcast_pillar_loadData_availability_30days_trend
    (
        dateProvided = null,
        sectionId = null
    )
    {
        ...
        // --
        var
            featureId = sectionId + '-performance-overview-comcast-pillar-availability-30days-trend',
        ...
        .append(
            ...
            .append(
                ...
                .addClass('ftr-header')
                .text('Comcast T6 Linear Stream Availability @ Pillar Trend (30 days)')
        ...
        var dateStartTimestamp = (dateEndTimestamp - (30 * (24 * 60 * 60)));
        ...
        loadDataApiQuery(
            ...
            {
                var
                    chartId = featureId + '-line-chart',         // the html div tag name
                ...
                for (date in dataArrayFromAPI)
                {
                    ...
                    for (index in dataArrayFromAPI[date])
                    {
                      ...
                      ({
                          ...
                          errorFreeRate : dataArrayFromAPI[date][index].average_errorfree_time_percentage    // preparing yAxis data
                      });
                    }
                 }
